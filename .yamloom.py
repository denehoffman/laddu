    ...
    jobs={
        'benchmarks': Job(
            steps=[
                ...
                script(
                    'cargo codspeed build --bench expression_ir_benchmarks',
                ),
                script(
                    'cargo codspeed build --bench workflow_behavior_cpu_benchmarks',
                ),
                script(
                    'cargo codspeed build --bench kmatrix_benchmark',
                ),
                action(
                    'CodSpeed Action',
                    'CodSpeedHQ/action',
