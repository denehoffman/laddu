...
def test_costheta_helicity() -> None:
    event = make_test_event()
    costheta = CosTheta('beam', ['proton'], ['kshort1'], ['kshort1', 'kshort2'], 'Helicity')
...
def test_costheta_gottfried_jackson() -> None:
    event = make_test_event()
    costheta = CosTheta('beam', ['proton'], ['kshort1'], ['kshort1', 'kshort2'], 'Gottfried-Jackson')
    assert pytest.approx(costheta.value(event)) == 0.09198832278031577


def test_phi_gottfried_jackson() -> None:
    event = make_test_event()
    phi = Phi('beam', ['proton'], ['kshort1'], ['kshort1', 'kshort2'], 'Gottfried-Jackson')
