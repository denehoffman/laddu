...
class J:
    value: int | Fraction
    def __init__(self, value: ScalarQuantumNumber | J) -> None: ...
...
class L:
    value: int
    def __init__(self, value: ScalarQuantumNumber | L) -> None: ...
    def projections(self) -> list[M]: ...
    def orbital_parity(self) -> Parity: ...

class M:
    value: int | Fraction
    def __init__(self, value: ScalarQuantumNumber | M) -> None: ...
    def __add__(self, other: ScalarQuantumNumber | M) -> M: ...
    def __radd__(self, other: ScalarQuantumNumber | M) -> M: ...
    def __sub__(self, other: ScalarQuantumNumber | M) -> M: ...
    def __rsub__(self, other: ScalarQuantumNumber | M) -> M: ...
    def __neg__(self) -> M: ...
...
class Parity:
    value: int
    def __init__(self, value: Sign | Parity) -> None: ...
    @staticmethod
    def positive() -> Parity: ...
    @staticmethod
    def negative() -> Parity: ...
    def __mul__(self, other: Sign | Parity) -> Parity: ...
...
class Charge:
    ...
    def __add__(self, other: ScalarQuantumNumber | Charge) -> Charge: ...
    def __radd__(self, other: ScalarQuantumNumber | Charge) -> Charge: ...
    def __sub__(self, other: ScalarQuantumNumber | Charge) -> Charge: ...
    def __rsub__(self, other: ScalarQuantumNumber | Charge) -> Charge: ...
