...
class Dataset:
    ...
    def p4_column_global(self, name: str) -> NDArray[np.float64]: ...
    def p4_column_local(self, name: str) -> NDArray[np.float64]: ...
    def aux_column_global(self, name: str) -> NDArray[np.float64]: ...
    def aux_column_local(self, name: str) -> NDArray[np.float64]: ...
