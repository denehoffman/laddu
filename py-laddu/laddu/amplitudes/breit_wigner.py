...
>>> expr = BreitWigner('rho', mass=parameter('rho_mass', 0.775), width=parameter('rho_width', 0.149), l=2, daughter_1_mass=Mass(["p1"]), daughter_2_mass=Mass(["p2"]), resonance_mass=Mass(["p1","p2"]))
>>> expr.norm_sqr()
NormSqr
└─ rho(id=0)
<BLANKLINE>
