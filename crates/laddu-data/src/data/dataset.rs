...
#[cfg(feature = "parallel")]
pub(super) mod accurate {
    use accurate::{sum::Sum2, traits::*};
    use num::complex::Complex64;

    #[derive(Clone)]
    pub(super) struct AccurateF64 {
        sum: Sum2<f64>,
    }
    ...
    #[derive(Clone)]
    pub(super) struct AccurateComplex64 {
        re: AccurateF64,
        im: AccurateF64,
    }
    ...
    impl AccurateComplex64 {
        ...
        pub(super) fn push(&mut self, value: Complex64) {
        ...
        pub(super) fn finish(self) -> Complex64 {
