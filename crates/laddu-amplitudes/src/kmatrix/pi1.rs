...
impl Amplitude for KopfKMatrixPi1 {
    ...
    fn compute(&self, parameters: &Parameters, cache_row: &CacheRow) -> Complex64 {
        ...
        let p_vec_constants = cache_row.get_matrix::<2, 1>(self.p_vec_cache_index);
...
pub fn py_kopf_kmatrix_pi1(
    ...
    Ok(PyAmplitude(KopfKMatrixPi1::new(
        name,
