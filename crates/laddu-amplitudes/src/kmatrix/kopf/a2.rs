...
pub struct KopfKMatrixA2 {
    ...
    couplings_real: [Parameter; 2],
    couplings_imag: [Parameter; 2],
...
impl KopfKMatrixA2 {
    /// Construct a new [`KopfKMatrixA2`] with activation tags, production couplings, channel,
    /// and input mass.
    ///
    ...
    pub fn new(
        ...
        let mut couplings_real: [Parameter; 2] = array::from_fn(|_| Parameter::default());
        let mut couplings_imag: [Parameter; 2] = array::from_fn(|_| Parameter::default());
        for i in 0..2 {
...
impl Amplitude for KopfKMatrixA2 {
    ...
    fn semantic_key(&self) -> Option<AmplitudeSemanticKey> {
        Some(
            AmplitudeSemanticKey::new("KopfKMatrixA2")
...
/// channel : laddu.KopfKMatrixA2Channel
...
mod tests {
    ...
    fn test_a2_gradient() {
        ...
        assert_relative_eq!(result[0][0].re, -0.5756896047697867);
