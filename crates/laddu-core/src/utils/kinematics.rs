...
use crate::{utils::enums::Frame, LadduError, LadduResult, Vec3, Vec4};
...
fn checked_boost_vector(beta: Vec3, context: &str) -> LadduResult<Vec3> {
    let beta2 = beta.mag2();
...
fn unit_vector(vector: Vec3, name: &str) -> LadduResult<Vec3> {
